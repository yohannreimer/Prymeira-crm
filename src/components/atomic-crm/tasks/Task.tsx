...
import type { Contact, Deal, Lead, Task as TData } from "../types";
...
export const Task = ({
  ...
  const getLeadRepresentation = useGetRecordRepresentation("leads");
                    ...
                    <ReferenceField<TData, Lead>
                      ...
                      render={({ referenceRecord }) => {
                        ...
                        return (
                          <>
                            {" "}
                            {translate("resources.tasks.regarding_lead", {
                              name: getLeadRepresentation(referenceRecord),
                            })}
                          </>
                        );
                      }}
