...
const Header = () => {
  ...
  if (matchPath("/", location.pathname)) {
    ...
    currentPath = "/deals";
  } else if (matchPath("/proposals/*", location.pathname)) {
            ...
            <div className="flex justify-between items-center flex-1">
              ...
              <div>
                <nav className="flex">
                  ...
                  />
                  <NavigationTab
                    label={translate("resources.agenda.name", {
                      smart_count: 1,
                    })}
                    to="/agenda"
                  ...
                  />
                  <NavigationTab
                    label={translate("resources.proposals.name", {
                      smart_count: 2,
                    })}
                    to="/proposals"
                    isActive={currentPath === "/proposals"}
                  />
                </nav>
              </div>
