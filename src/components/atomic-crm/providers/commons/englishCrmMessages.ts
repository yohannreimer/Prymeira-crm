export const englishCrmMessages = {
  resources: {
    ...
    tasks: {
      ...
      due_states: {
        future: "in %{smart_count} days",
        overdue: "%{smart_count} day overdue |||| %{smart_count} days overdue",
        today: "due today",
        tomorrow: "due tomorrow",
      },
      open_for_deal: "Open tasks for this deal",
      open_more_count: "+%{smart_count} task |||| +%{smart_count} tasks",
