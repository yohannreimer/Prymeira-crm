...
begin
  ...
  alter table public.deals
    add column if not exists pipeline_id bigint references public.pipelines(id);
...
create index if not exists deals_pipeline_id_idx on public.deals using btree (pipeline_id);
